            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="position-center">
                        ...
                        <form role="form"
                            action="{{URL::to('/update-product/'.$info_product->product_id.'/'.$info_product->product_image)}}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="product_content" class="form-control" id="product_content"
                                    value="{{$info_product->product_content}}">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Hình ảnh sản phẩm</label>
                                <input type="file" name="product_image" class="form-control" id="product_image">
                                <img src="{{URL::to('public/uploads/products/'.$info_product->product_image)}}"
                                    alt="product" width="120px" height="120px" id="show_product_image">
                            </div>
                            <div class="form-group">
